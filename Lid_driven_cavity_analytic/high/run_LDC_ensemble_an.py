...
from NavierStokesLDC_an import Navier_Stokes_LDC

# Load Random Variables

content = loadmat('../LDC_data/Re_vec.mat')
...
for i in range(200): #200
    ...
    u_y_array, u_x_array, p_array_mid, p_array_vert, p_array_base, p_field, u_x_field, u_y_field = Navier_Stokes_LDC(Re, nx)
...
scipy.io.savemat('./u_meshes1/u_matrix.mat', mdict={'u_matrix_0':u_matrix_0, 'u_matrix_1':u_matrix_1, 'u_matrix_2':u_matrix_2, 'u_matrix_3':u_matrix_3, 'u_matrix_4':u_matrix_4, 'u_matrix_5':u_matrix_5, 'u_matrix_6':u_matrix_6, 'u_matrix_7':u_matrix_7})
