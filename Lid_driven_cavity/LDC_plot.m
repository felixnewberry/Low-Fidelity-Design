...
legend([p1,p5],{'$U$ Mid','$P$ Base'},'interpreter', 'latex', 'fontsize', FS_leg)
axis tight
set(gca,'Fontsize', FS_axis, 'linewidth',LW_axis);%box on
% grid on
...
% load('LDC_design/grid_search_2_Transform.mat')
...
plot_label = ["$U$ Mid","$U$ Vert", "$P$ Mid", "$P$ Vert", "$P$ Base"]; 
...
% figure
% hold on
% % contourf(100*delta_nu_vec,100*delta_u_vec,100*reshape(Re',length(delta_nu_vec), length(delta_u_vec))')
% contourf(100*delta_nu_vec,100*delta_u_vec,Re)
% p1 = plot(0,0,'ro','MarkerSize',8,'linewidth',LW);
% p2 = plot(100*nu_bound(i_qoi),100*u_bound(i_qoi),'rx','MarkerSize',8,'linewidth',LW);
% p3 = plot(100*nu_bi(i_qoi),100*u_bi(i_qoi),'rs','MarkerSize',8,'linewidth',LW);
% hold off
% 
% % 100 and less for Re is safe. 200 seems good. 240 is on edge... for P Mid.
% % Test a limit of 225... 
% % Have to validate this process somehow... 
% % 
% % exclude Re above a certain range... 
...
results_mat = [nom_low, nom_bound, nom_bi, opt_low, min_bound, min_bi_opt, min_bi]'*100; 

results_tab = array2table(results_mat,...
    'VariableNames',{'U_Mid', 'U_Vert', 'P_Mid', 'P_Vert', 'P_Base' },'RowNames',{'Nom Low','Nom Bound','Nom Bi', 'Opt Low', 'Opt Bound', 'Opt Bi','Best Bi'});
results_tab
1; 
...
% plot base pressure
% This is questionable - I may be plotting base.. but should I be plotting
% P mid? 
...
% Case 1: exluce NaN runs. 
% Case 2: exclude Re >= 175

% Look into 'LDC_design/u_mid_opt_2.mat' 
% and P_base_opt_2
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Add opt low to results
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
opt_low = [e_low_u, 0, 0, 0, e_low_pb]'; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% sv_L_nom = svd(Uc_nom_pb); 
% sv_L_Opt = svd(Uc_opt_pb); 
% 
% i_lim = 5; 
% 
% % normalized
